...
# the command takes the notebook.ipynb and converts into a notebook.py file
#!/usr/bin/env python
# coding: utf-8
...
def ingest_data(pg_user, pg_pass, pg_host, pg_port, pg_db, target_table, year, month, chunksize):
    # year = "2021"
    # month = "07"
    # pg_user = 'root'
    # pg_pass = 'root'
